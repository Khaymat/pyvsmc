...
def detect_structure(
    ...
    *,
    ...
    break_above_sh = valid_close & valid_sh & (cl > last_sh_before)
    break_below_sl = valid_close & valid_sl & (cl < last_sl_before)
...
def structure_polars(
    ...
    *,
    ...
    res = detect_structure(high, low, close, window_size=window_size)
